...
#   H0: mu1 == mu2, H1: mu1 != mu2 (양측) => mu1 - mu2 = 0
...
from scipy.stats import ttest_ind, bartlett, levene # 등분산 검정용 함수
...
#    않을 경우 N으로 답하시오. => 유의수준 0.01로 하라는 의미
...
# 2. 대응인 t 검정 - 육류 종류별(반복)로 연도별(대응) 고려
# (1) 육류 종류
...
# 3. 두 국가 간의 연도별 소비량 차이가 없는 것으로 판단할 수 있는 육류 종류를 모두
# 적으시오.
...
# 3. Train 데이터를 사용하여 의사결정나무 학습을 수행
# • Feature: Age_gr, Gender, Work_Experience, Family_Size, 
#             Ever_Married, Graduated, Spending_Score
# • Parameter : Gini / Max Depth = 7 / Seed = 123
